    ...
    function Selector(chart, options) {
        ...
        function startDrag(e) {
            ...
            if (currentItem && t.selection.indexOf(currentItem) === -1) {
                ...
                t.chart.events.callListeners(cl.Event.select, e.originalEvent, t.selection);
            }
            if (t.selection.length === 0) return;
            ...
            t.chart.events.callListeners(cl.Event.dragStart, e.originalEvent, drag.items);
        }
        ...
        function onMouseUp(e) {
            ...
            if (drag.active) {
                ...
                // Stop dragging
                t.chart.events.callListeners(cl.Event.dragEnd, e.originalEvent, drag.items);
                drag.items = null;
                drag.active = false;
                drag.prepared = false;
                t.apply();
